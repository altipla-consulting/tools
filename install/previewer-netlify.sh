...
echo "----------"
curl https://github.com/altipla-consulting/tools/releases/download/${LATEST_VERSION}/${TOOL}_${LATEST_VERSION}_linux_amd64 > /usr/local/bin/$TOOL
